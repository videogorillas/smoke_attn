...
if __name__ == '__main__':
    ...
    # _x1 = numpy.load("/Volumes/SD128/emb/MACG_S02_Ep024_ING_5764188.mov.npy")
    # _x1 = numpy.load("/Volumes/bstorage/home/chexov/macg_embedding/BX137_SRNA_03.mov.npy")
    _x1 = numpy.load("/Volumes/SD128/emb/BX137_SRNA_03.mov.npy")
    ...
    embedding = project(_x1)
    plot_emb(embedding, ax)
    emb_to_tsv(embedding, "umap.tsv")
